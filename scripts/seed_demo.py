...
while cur <= today:
    ...
    for dd, amt, merch, cat, pay in [
        (1, 950.0, "Landlord Ltd", "Rent/Mortgage", "Bank Transfer"),
        (15, round(random.uniform(105, 140), 2), "British Gas", "Utilities", "Bank Transfer"),
...
while day <= today:
    ...
    if random.random() < 0.10:
        tx.append((day, round(random.uniform(48, 72), 2), random.choice(FUEL), "Fuel", "Card", ""))
